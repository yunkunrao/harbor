...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.SoftQuotaPerProjectEnable, Scope: UserScope, Group: QuotaGroup, EnvKey: "SOFT_QUOTA_PER_PROJECT_ENABLE", DefaultValue: "true", ItemType: &BoolType{}, Editable: true},
